...
@view_config(route_name='project_view', permission='coordinator')
class View(BaseView):
    def get(self):
...
@view_config(route_name='project_add', permission='coordinator')
class Add(BaseView):
    def dispatch(self):
...
@view_config(route_name='project_delete', renderer='intranet3:templates/common/delete.html', permission='admin')
